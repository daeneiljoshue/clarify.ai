...
describe('Feature: get webhooks', () => {
    test('get all webhooks', async () => {
        const result = await clarify.webhooks.get({});
...
describe('Feature: create a webhook', () => {
    test('create new webhook', async () => {
        const webhook = new clarify.classes.Webhook({
...
describe('Feature: update a webhook', () => {
    test('update some webhook fields', async () => {
        ...
        let result = await clarify.webhooks.get({
            id: 1,
        });
        let [webhook] = result;
        ...
        result = await clarify.webhooks.get({
            id: 1,
        });
        [webhook] = result;
