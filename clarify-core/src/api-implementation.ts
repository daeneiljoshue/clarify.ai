...
export default function implementAPI(cvat: CLARIFYCore): CLARIFYCore {
    ...
    implementationMixin(cvat.jobs.get, async (
        query: Parameters<CLARIFYCore['jobs']['get']>[0],
    ): ReturnType<CLARIFYCore['jobs']['get']> => {
        checkFilter(query, {
            page: isInteger,
            filter: isString,
            sort: isString,
    ...
    implementationMixin(cvat.tasks.get, async (
        filter: Parameters<CLARIFYCore['tasks']['get']>[0],
    ): ReturnType<CLARIFYCore['tasks']['get']> => {
        checkFilter(filter, {
            page: isInteger,
            projectId: isInteger,
            id: isInteger,
    ...
    implementationMixin(cvat.projects.get, async (
        filter: Parameters<CLARIFYCore['projects']['get']>[0],
    ): ReturnType<CLARIFYCore['projects']['get']> => {
        checkFilter(filter, {
            id: isInteger,
            page: isInteger,
            search: isString,
