...
import tempfile
import os
from django.conf import settings  # Common location for BASE_DIR in Django

# Access BASE_DIR using settings.BASE_DIR
...
_temp_dir = tempfile.TemporaryDirectory(dir=BASE_DIR, suffix="clarify")
...
# testing behavior.
TEST_RUNNER = "clarify.settings.testing.PatchedDiscoverRunner"
