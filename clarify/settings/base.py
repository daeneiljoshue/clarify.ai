...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('CLARIFY_POSTGRES_HOST', 'clarify_db'),
        'NAME': os.getenv('CLARIFY_POSTGRES_DBNAME', 'clarify'),
        'USER': os.getenv('CLARIFY_POSTGRES_USER', 'root'),
        'PASSWORD': postgres_password,
        'PORT': os.getenv('CLARIFY_POSTGRES_PORT', 5432),
        'OPTIONS': {
            'application_name': os.getenv('CLARIFY_POSTGRES_APPLICATION_NAME', 'clarify'),
        },
    }
}
...
CLARIFYCONCURRENT_CHUNK_PROCESSING = int(os.getenv('CLARIFY_CONCURRENT_CHUNK_PROCESSING', 1))

from clarify.rq_patching import update_started_job_registry_cleanup
