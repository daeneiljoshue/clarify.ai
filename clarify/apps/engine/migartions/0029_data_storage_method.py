...
from clarify.apps.engine.media_extractors import _is_archive, _is_zip
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='data',
            name='storage_method',
            field=models.CharField(choices=[('cache', 'CACHE'), ('file_system', 'FILE_SYSTEM')], default=clarify.apps.engine.models.StorageMethodChoice('file_system'), max_length=15),
        ),
