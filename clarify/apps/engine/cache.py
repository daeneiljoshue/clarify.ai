...
from clarify.apps.engine.cloud_provider import (Credentials,
                                             db_storage_to_storage_instance,
                                             get_cloud_storage_instance)
from clarify.apps.engine.log import ServerLogManager
from clarify.apps.engine.media_extractors import (ImageDatasetManifestReader,
                                               Mpeg4ChunkWriter,
                                               Mpeg4CompressedChunkWriter,
                                               VideoDatasetManifestReader,
                                               ZipChunkWriter,
                                               ZipCompressedChunkWriter)
from clarify.apps.engine.mime_types import mimetypes
from clarify.apps.engine.models import (DataChoice, DimensionType, Job, Image,
                                     StorageChoice, CloudStorage)
from clarify.apps.engine.utils import md5_hash, preload_images
...
class MediaCache:
    ...
    def _get_frame_provider_class():
        from clarify.apps.engine.frame_provider import \
