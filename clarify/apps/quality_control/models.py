...
from clarify.apps.engine.models import Job, ShapeType, Task
...
class QualityReport(models.Model):
    ...
    def _parse_report(self):
        from clarify.apps.quality_control.quality_reports import ComparisonReport
...
class QualitySettings(models.Model):
    ...
    def get_defaults(cls) -> dict:
        import clarify.apps.quality_control.quality_reports as qc
