...
import logger, { EventScope } from 'clarify-logger';
...
class GlobalErrorBoundary extends React.PureComponent<Props, State> {
  ...
  public render(): React.ReactNode {
    ...
    if (hasError && error) {
      const message = `<span class="math-inline">\{error\.name\}\\n</span>{error.message}\n\n${error.stack}`;
      return (
        <div className='clarify-global-boundary'>
                      <Result
            status='error'
          ...
          >
            <div>
              <Paragraph>
                ...
                <Collapse accordion defaultActiveKey={['errorMessage']}>
                  <Collapse.Panel header='Error message' key='errorMessage'>
                    <Text type='danger'>
                      <TextArea
                        className='clarify-global-boundary-error-field'
                        autoSize
                        value={message}
                      />
                    </Text>
              ...
              <ul>
                <li>
                  <ClarifyTooltip title='Copied!' trigger='click'>
                ...
                {job ? (
                  <li>
                    ...
                    if you wish Clarify tried to restore your annotation progress or
                    {/* eslint-disable-next-line */}
