...
export default function InvitationsListComponent(props: Props): JSX.Element {
    ...
    return (
        <>
            <Row justify='center' align='top' className='clarify-invitations-list-content'>
                <Col className='clarify-invitations-list' {...dimensions}>
                    {invitations.map(
            ...
            <Row justify='center' align='middle'>
                <Col {...dimensions}>
                    <Pagination
                        className='clarify-invitations-pagination'
