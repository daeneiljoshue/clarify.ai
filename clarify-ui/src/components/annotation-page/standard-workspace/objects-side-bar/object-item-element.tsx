...
import { ObjectState } from 'clarify-core-wrapper';
...
function ObjectItemElementComponent(props: OwnProps): JSX.Element {
    ...
    const elementClassName = element.clientID === activatedElementID ?
        'clarify-objects-sidebar-state-item-elements clarify-objects-sidebar-state-active-element' :
        'clarify-objects-sidebar-state-item-elements';

    return (
        <div
            id={`clarify-objects-sidebar-state-item-element-${element.clientID}`}
