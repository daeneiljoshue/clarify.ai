...
import { Canvas, convertShapesForInteractor } from 'clarify-canvas-wrapper';
import {
                ...
                .map((objectState: any): React.ReactPortal | null => {
                    ...
                    if (targetElement) {
                        ...
                        return ReactDOM.createPortal(
                            <Col>
                                {isTracked ? (
                                    <CLARIFYTooltip overlay='Disable tracking'>
                                        <EnvironmentFilled
                                            onClick={() => {
                                    ...
                                    <CLARIFYTooltip overlay={`Enable tracking using ${activeTracker.name}`}>
                                        <EnvironmentOutlined
                                            onClick={() => {
