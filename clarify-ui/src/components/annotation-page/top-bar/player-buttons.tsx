...
function PlayerButtons(props: Props): JSX.Element {
    ...
    return (
        <Col className='cvat-player-buttons'>
            ...
            >
                <CLARIFYTooltip placement='top' title={`${prevButtonTooltipMessage} ${previousFrameShortcut}`}>
                    {prevButton}
                </CLARIFYTooltip>
            </Popover>
            ...
            >
                <CLARIFYTooltip placement='top' title={`${nextButtonTooltipMessage} ${nextFrameShortcut}`}>
                    {nextButton}
                </CLARIFYTooltip>
            </Popover>
