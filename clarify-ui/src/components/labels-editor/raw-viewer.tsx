    ...
    private handleSubmit = (values: Store): void => {
        ...
        if (deletedLabels.length || deletedAttributes.length) {
            Modal.confirm({
                ...
                className: 'clarify-modal-confirm-remove-existing-labels',
                content: (
                    <>
                        {deletedLabels.length ? (
                            <Paragraph>
                                Following labels are going to be removed:
                                <div className='clarify-modal-confirm-content-remove-existing-labels'>
                                    {deletedLabels
                        ...
                        {deletedAttributes.length ? (
                            <Paragraph>
                                ...
                                <div className='clarify-modal-confirm-content-remove-existing-attributes'>
                ...
                <Form.Item name='labels' initialValue={textLabels} rules={[{ validator: validateLabels }]}>
                    <Input.TextArea
                        onPaste={(e: React.ClipboardEvent) => {
                            ...
                            const element = window.document.getElementsByClassName('clarify-raw-labels-viewer')[0] as HTMLTextAreaElement;
                        ...
                        rows={5}
                        className='clarify-raw-labels-viewer'
                    />
                </Form.Item>
