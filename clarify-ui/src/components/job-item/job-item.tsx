...
function ReviewSummaryComponent({ jobInstance }: { jobInstance: any }): JSX.Element {
    ...
    return (
        <table className='clarify-review-summary-description'>
            <tbody>
                <tr>
                    <td>
...
function JobItem(props: Props): JSX.Element {
    ...
    return (
        <Col span={24}>
            <Card className='clarify-job-item' style={{ ...style }} data-row-id={job.id}>
                <Row>
                    <Col span={7}>
                        <Row>
                            <Col>
                        ...
                        <Row className='clarify-job-item-dates-info'>
                            <Col>
                    ...
                    <Col span={7}>
                        <Row className='clarify-job-item-selects' justify='space-between'>
                            <Col>
                                <Row>
                                    <Col className='clarify-job-item-select'>
                                        <Row>
                                            <Text>Assignee:</Text>
                                        </Row>
                                        <UserSelector
                                            className='clarify-job-assignee-selector'
                                            value={job.assignee}
                    ...
                    <Col span={10}>
                        <Row className='clarify-job-item-details'>
                            <Col>
                                <Row>
                                    <Col>
                                        <ProjectOutlined />
                                        <Text>State: </Text>
                                        <Text type='secondary' className='clarify-job-item-state'>
                            ...
                            <Col offset={2}>
                                    ...
                                    job.type !== JobType.GROUND_TRUTH && (
                                        <Row>
                                            <Col>
                                                ...
                                                <Text type='secondary' className='clarify-job-item-frame-range'>
                                ...
                                <Row>
                                    <Col>
                                        ...
                                        <Text type='secondary' className='clarify-job-item-frames'>
                ...
                >
                    <MoreOutlined className='clarify-job-item-more-button' />
                </Dropdown>
            </Card>
        </Col>
    );
