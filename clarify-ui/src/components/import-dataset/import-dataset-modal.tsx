...
import { getCore, Storage, StorageData } from 'clarify-core-wrapper';
...
function ImportDatasetModal(props: StateToProps): JSX.Element {
    ...
    const onUpload = (): void => {
        if (uploadParams && uploadParams.resource) {
            ...
            Notification.info({
                ...
                className: `clarify-notification-notice-import-${uploadParams.resource}-start`,
            });
        }
    };
    ...
    const confirmUpload = (): void => {
        confirm({
            ...
            className: `clarify-modal-content-load-${instanceType.split(' ')[0]}-annotation`,
            onOk: () => {
                onUpload();
            },
            okButtonProps: {
    ...
    return (
        <>
            <Modal
                    ...
                    <>
                        ...
                        </Text>
                        {
                            instance instanceof core.classes.Project && (
                                ...
                                >
                                    <QuestionCircleOutlined className='clarify-modal-import-header-question-icon' />
                                </CLARIFYTooltip>
                            )
                        }
                    </>
                ...
                onCancel={closeModal}
                onOk={() => form.submit()}
                className='clarify-modal-import-dataset'
                destroyOnClose
            >
                <Form
                ...
                >
                    ...
                    >
                        <Select
                            ...
                            className='clarify-modal-import-select'
                            virtual={false}
                                    ...
                                    (importer: any): JSX.Element => {
                                        ...
                                        return (
                                            <Select.Option
                                                ...
                                                key={importer.name}
                                                disabled={disabled}
                                                className='clarify-modal-import-dataset-option-item'
                                            >
                                                <UploadOutlined />
                    ...
                    <Space className='clarify-modal-import-switch-conv-mask-to-poly-container'>
                        <Form.Item
                            name='convMaskToPoly'
                            valuePropName='checked'
                            className='clarify-modal-import-switch-conv-mask-to-poly'
                        >
                            <Switch
                        ...
                        <CLARIFYTooltip title='The option is relevant for formats that work with masks only'>
                            <QuestionCircleOutlined />
                        </CLARIFYTooltip>
                    </Space>
                    <Space className='clarify-modal-import-switch-use-default-storage-container'>
                        <Form.Item
                            name='useDefaultSettings'
                            valuePropName='checked'
                            className='clarify-modal-import-switch-use-default-storage'
                        >
                            <Switch
                                onChange={(value: boolean) => {
                        ...
                        <CLARIFYTooltip title={helpMessage}>
                            <QuestionCircleOutlined />
                        </CLARIFYTooltip>
                    </Space>
                    {!useDefaultSettings && (
