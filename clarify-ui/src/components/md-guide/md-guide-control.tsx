...
function MdGuideControl(props: Props): JSX.Element {
    ...
    return (
        <Row justify='start' className='clarify-md-guide-control-wrapper'>
            <Col span={24}>
                <Text strong className='clarify-text-color'>{`${instanceType[0].toUpperCase()}${instanceType.slice(1)} description`}</Text>
                <br />
                <Button
                    onClick={() => {
