...
class AdvancedConfigurationForm extends React.PureComponent<Props> {
    ...
    private renderCopyDataChechbox(): JSX.Element {
        return (
            <Form.Item
                help='If you have a low data transfer rate over the network you can copy data into CLARIFY to speed up work'
                name='copyData'
                valuePropName='checked'
            >
                <Checkbox>
                    <Text className='cvat-text-color'>Copy data into CLARIFY</Text>
                </Checkbox>
            </Form.Item>
        );
    }
    ...
    private renderImageQuality(): JSX.Element {
        return (
            <CLARIFYTooltip title='Defines images compression level'>
                <Form.Item
                    label='Image quality'
                    name='imageQuality'
                    rules={[
    ...
    private renderOverlap(): JSX.Element {
        return (
            <CLARIFYTooltip title='Defines a number of intersected frames between different segments'>
                <Form.Item
                    label='Overlap size'
                    name='overlapSize'
    ...
    private renderSegmentSize(): JSX.Element {
        return (
            <CLARIFYTooltip title='Defines a number of frames in a segment'>
    ...
    private renderUzeZipChunks(): JSX.Element {
        return (
            <Space>
                ...
                <Text className='clarify-text-color'>Prefer zip chunks</Text>
        ...
        return (
            <Space>
                <Form.Item
                    name='useCache'
                    valuePropName='checked'
                    className='clarify-settings-switch'
                >
                    <Switch defaultChecked />
                </Form.Item>
                <Text className='clarify-text-color'>Use cache</Text>
