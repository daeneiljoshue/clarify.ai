...
import { ServerError } from 'clarify-core-wrapper';
                ...
                errors: {
                    ...
                    webhooks: {
                        ...
                        fetching: {
                            ...
                            reason: action.payload.error,
                            shouldLog: !(action.payload.error instanceof ServerError),
                            className: 'clarify-notification-notice-get-webhooks-failed',
                        },
                    },
                },
            };
                ...
                errors: {
                    ...
                    webhooks: {
                        ...
                        creating: {
                            ...
                            reason: action.payload.error,
                            shouldLog: !(action.payload.error instanceof ServerError),
                            className: 'clarify-notification-notice-create-webhook-failed',
                        },
                    },
                },
            };
                ...
                errors: {
                    ...
                    webhooks: {
                        ...
                        updating: {
                            ...
                            reason: action.payload.error,
                            shouldLog: !(action.payload.error instanceof ServerError),
                            className: 'clarify-notification-notice-update-webhook-failed',
                        },
                    },
                },
            };
                ...
                errors: {
                    ...
                    webhooks: {
                        ...
                        deleting: {
                            ...
                            reason: action.payload.error,
                            shouldLog: !(action.payload.error instanceof ServerError),
                            className: 'clarify-notification-notice-delete-webhook-failed',
                        },
                    },
                },
            };
