...
from clarify_sdk.datasets.caching import UpdatePolicy, make_cache_manager
from clarify_sdk.datasets.task_dataset import TaskDataset
from clarify_sdk.pytorch.common import Target
...
class TaskVisionDataset(torchvision.datasets.VisionDataset):
    """
    Represents a task on a CLARIFY server as a PyTorch Dataset.
