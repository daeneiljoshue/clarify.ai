...
import clarify_sdk.auto_annotation as cvataa
from clarify_sdk import Client, models
from clarify_sdk.core.helpers import DeferredTqdmProgressReporter
from clarify_sdk.core.proxies.tasks import ResourceType
...
class CLI:
    ...
    def tasks_create(
        ...
        *,
        ...
        annotation_path: str = "",
        annotation_format: str = "CLARIFY XML 1.1",
    ...
    def tasks_auto_annotate(
        ...
        *,
        ...
        if function_module is not None:
            ...
            module_spec = importlib.util.spec_from_file_location("__clarify_function__", function_file)
